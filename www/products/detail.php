...
LocalRedirect("/products/");
$APPLICATION->SetPageProperty("description", "Инобитек DICOM-просмотрщик — современный программный продукт для просмотра медицинских исследований с продвинутой 3D-визуализацией и всем необходимым функционалом просмотра в 2D");
$APPLICATION->SetPageProperty("keywords", "DICOM, dicom, viewer, просмотрщик, просмотровщик, 2D, 3D, MPR, ECG");
$APPLICATION->SetPageProperty("title", "Инобитек DICOM-просмотрщик — кросс-платформенный просмотрщик DICOM-данных с продвинутой 3D-визуализацией");
?>
