...
$APPLICATION->SetPageProperty("title", "Inobitec / distributives de productos propios para descargar: Inobitec Visor DICOM, Inobitec Web Visor DICOM, DICOM Inobitec Server (PACS)");
$APPLICATION->SetTitle("Descargas");
$no_f_links = true;
?>
