...
$APPLICATION->SetPageProperty("title", "Inobitec / Software para la Salud: Inobitec Visor DICOM, Inobitec Web Visor DICOM, DICOM Inobitec Servidor (PACS), desarrollo de software personalizado");
$APPLICATION->SetTitle("Inobitec / Software para la Salud: Inobitec Visor DICOM, Inobitec Web Visor DICOM, DICOM Inobitec Servidor (PACS), desarrollo de software personalizado");
$APPLICATION->AddHeadScript('/verstka_new/js/jquery.touchSwipe.min.js');
$APPLICATION->AddHeadScript('/verstka_new/js/slider.js');
?><!-- MP-BANNER --> <?require($_SERVER["DOCUMENT_ROOT"]."/include/mainslider.php");?> <!-- END :: MP-BANNER --> <!-- START :: MP-SOLUTIONS --> <?
  //echo "<pre>"; var_dump($_SERVER["DOCUMENT_ROOT"]."/include/mainslider.php"); echo "</pre>";

//require($_SERVER["DOCUMENT_ROOT"].SITE_DIR."includes/mp_solutions.php");
require($_SERVER["DOCUMENT_ROOT"]."/includes/mp_solutions.php");

?> <!-- END :: MP-SOLUTIONS --> <!-- START :: MP-PO -->
<div class="mp-po">
  <div class="inn">
    <div class="title">
       <?
 ...
 <a href="/esp/services/" class="more-button bold"><?=$MESS[SITE_ID]['MORE']?></a>
    <div class="cl">
    </div>
  </div>
 <img width="1200" alt="разработка ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ" src="/bitrix/templates/main/img/mp-po-bg.jpg" height="675">
</div>
 <!-- END :: MP-PO --> <?
