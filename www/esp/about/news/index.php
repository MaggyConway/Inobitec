...
LocalRedirect("/eng/");
$APPLICATION->SetPageProperty("description", "Official news and press-releases of Inobitec LLC");
$APPLICATION->SetPageProperty("keywords", "Inobitec, company, news, press-releases, blog");
$APPLICATION->SetPageProperty("title", "Inobitec / News");
