...
$APPLICATION->SetPageProperty("title", "Inobitec / Formulario de contactos y comentarios");
$APPLICATION->SetTitle("Contactos");
?>

<style>
	.form__feedback input[type=file] {
		display: none;
	}
	.es_contacts .form__feedback .line .value.file label {
		line-height: 18px;
		font-size: 14px;
		padding-left: 20px;
		padding-right: 20px;
...
<div class="page-contacts es_contacts">
