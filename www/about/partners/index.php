...
$APPLICATION->SetPageProperty("description", "Партнеры компании Инобитек");
$APPLICATION->SetPageProperty("keywords", "Инобитек, компания, партнеры");
$APPLICATION->SetPageProperty("title", "Инобитек / Партнеры компании");
$APPLICATION->SetTitle("Партнеры");


// echo "<pre>"; var_dump(SITE_ID); echo "</pre>";
