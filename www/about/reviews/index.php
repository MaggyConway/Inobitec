...
$APPLICATION->SetPageProperty("description", "Отзывы о компании Инобитек");
$APPLICATION->SetPageProperty("keywords", "Инобитек, компания, отзывы");
$APPLICATION->SetPageProperty("title", "Инобитек / Отзывы о компании");
$APPLICATION->SetTitle("Отзывы");
?><?
	$сache = Bitrix\Main\Data\Cache::createInstance();

	if(false && $сache -> initCache(36000, 'reviews__list'.SITE_ID)) 
	{ 
...
<div class="reviews-page">
	<div class="reviews__list">
		<ul>
			...
			<li> <span class="inn"><a data-fancybox="popup-image" href="<?=$arItem['DETAIL_PICTURE']['src']?>"><img alt="<?=$arItem['NAME']?>" src="<?=$arItem['PREVIEW_PICTURE']['src']?>
