...
LocalRedirect("/");
$APPLICATION->SetPageProperty("description", "Официальные новости и пресс-релизы компании Инобитек");
$APPLICATION->SetPageProperty("keywords", "Инобитек, компания, новости, пресс-релизы, блог");
$APPLICATION->SetPageProperty("title", "Инобитек / Новостная лента");
