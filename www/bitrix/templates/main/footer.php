            ...
            <?
				if (
					CSIte::InDir('/') || CSIte::InDir('/eng/') || CSIte::InDir('/fra/') || CSIte::InDir('/deu/') ||
					CSIte::InDir('/personal/') || CSIte::InDir('/eng/personal/') || CSIte::InDir('/fra/personal/') || CSIte::InDir('/deu/personal/') ||
					CSIte::InDir('/login/') || CSIte::InDir('/eng/login/') || CSIte::InDir('/fra/login/') || CSIte::InDir('/deu/login/') ||
					CSIte::InDir('/search/') || CSIte::InDir('/eng/search/') || CSIte::InDir('/fra/search/') || CSIte::InDir('/deu/search/') ||
					CSIte::InDir('/support/') || CSIte::InDir('/eng/support/') || CSIte::InDir('/fra/support/') || CSIte::InDir('/deu/support/') ||
					CSIte::InDir('/distribution/') || CSIte::InDir('/eng/distribution/') || CSIte::InDir('/fra/distribution/') || CSIte::InDir('/deu/distribution/')
				){ 
					$no_f_links = true;
				}
        ...
        <div class="popup-main">
          <button class="close" type="button" data-fancybox-close>
            <svg width="27" height="27">
              <use xlink:href="<?=SITE_TEMPLATE_PATH?>/2020/img/sprite.svg#sprite-popup-close"></use>
            </svg>
          </button>
          <svg width="160" height="160">
            <use xlink:href="<?=SITE_TEMPLATE_PATH?>/2020/img/sprite.svg#sprite-success-check-mark"></use>
          </svg>
          <p class="popup__title"><?=GetMessage("CUSTOM.FOOTER.POPUP.SENDMESSAGE")?></p>
          <p><?=GetMessage("CUSTOM.FOOTER.POPUP.THANKSMESSAGE")?></p>
          <button class="btn btn--light-blue-outline popup__button" type="button" data-fancybox-close><?=GetMessage("CUSTOM.FOOTER.POPUP.CLOSE")?></button>
        </div>
      </div>
      <div class="popup" id="error-popup">
        <div class="popup-main">
          ...
          <svg width="160" height="160">
            <use xlink:href="<?=SITE_TEMPLATE_PATH?>/2020/img/sprite.svg#sprite-error-cross"></use>
          </svg>
          <p class="popup__title"><?=GetMessage("CUSTOM.FOOTER.POPUP.SENDMESSAGEERROR")?></p>
          <p><?=GetMessage("CUSTOM.FOOTER.POPUP.FORMNOTSEND")?></p>
          <button class="btn btn--light-blue-outline popup__button" type="button" data-fancybox-close><?=GetMessage("CUSTOM.FOOTER.POPUP.CLOSE")?></button>
        </div>
      </div>
      <div class="popup" id="distribution-success-popup">
        <div class="popup-main">
          ...
          <p class="popup__title"><?=GetMessage("CUSTOM.FOOTER.POPUP.DESTRIBSUCC")?></p>
          <p><?=GetMessage("CUSTOM.FOOTER.POPUP.DESTRIBMESS")?></p>
          <button class="btn btn--light-blue-outline popup__button" type="button" data-fancybox-close><?=GetMessage("CUSTOM.FOOTER.POPUP.CLOSE")?></button>
        </div>
      </div>  
