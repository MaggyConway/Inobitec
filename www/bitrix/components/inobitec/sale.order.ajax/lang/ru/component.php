...
$MESS['STOF_ERROR_EMAIL_EXIST'] = "Пользователь с таким Email'ом уже существует";
$MESS['STOF_ERROR_SHORT_PASS'] = "Пароль слишком короткий";
$MESS['STOF_ERROR_PASS_SYMBOLS'] = "Допустимы латинские буквы и цифры для пароля";
