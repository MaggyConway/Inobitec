...
$APPLICATION->SetPageProperty("title", "Inobitec / Distributives of own products for download: Inobitec DICOM Viewer, Inobitec Web DICOM Viewer, Inobitec DICOM Server (PACS)");
