...
$APPLICATION->SetPageProperty("title", "Inobitec / Distribution");
...
<div class="distribution-header">
 ...
 <img src="/bitrix/templates/main/2020/img/logo-blue.svg" alt="Инобитек">
		...
		<div class="distribution-header__container">
			<div class="distribution-header__description">
				 <?=$ar_res['DESCRIPTION']?> <a class="btn btn--light-blue-outline distribution-header__btn js-distribution-header-btn" href="#distributor-questionnaire">Fragebogen ausfüllen</a>
			</div>
 ...
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array("ATT_OPTIONS",""),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
		"SET_META_KEYWORDS" => "Y",
	...
	false
);?> <script src="https://www.google.com/recaptcha/api.js?render=6LdNy7wUAAAAAPeRFWzbD3GIijmFnH-dJ_oNE8YD"></script> <script>
