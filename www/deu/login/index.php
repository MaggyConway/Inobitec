...
//print_r("TEST");
$APPLICATION->SetTitle("Anmelden");
?>
<div class="success-block">
    <div class="popup-main">
        <img src="/img/svg/checkbox.svg">
        <p class="success">Sie sind registriert und haben sich erfolgreich angemeldet</p>
        <button class="btn-blue" onclick="window.location.href='/eng/';">ZUR HAUPTSEITE</button>
    </div>
</div>
