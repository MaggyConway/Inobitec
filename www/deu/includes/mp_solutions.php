...
/*
	if($result){
?>
<div class="mp-solutions">
		<?
		foreach ($result as $key => $arItem) {
			//$ico = CFIle::GetFileArray();
		?>
	<a class="mp-solutions__item i<?=$key+1?>" href="<?=$arItem['DETAIL_PAGE_URL']?>">
		<span class="ico"><img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" width="<?=$arItem['PREVIEW_PICTURE']['WIDTH']?>" height="<?=$arItem['PREVIEW_PICTURE']['HEIGHT']?>" alt="<?=$arItem['NAME']?>"></span>
		<span class="text">
			<?=$arItem['~PROPERTY_NAME_FORMATED_LIST_VALUE']['TEXT']?>
		</span>
	</a>
		<?
		}
      ...
      ?>
          <div class="product">
            ...
            <div class="product__row">
                ...
                <button type="button" class="btn-blue" data-open-case="case-<?=$keyItem+1?>">Details<?/*Loc::getMessage('MP_SOLUTIONS_MORE')*/?></button>
            </div>
            ...
            <div class="product-description hidden-case" data-case-name="case-<?=$keyItem+1?>">
                      ...
                      <div class="product-module">
                          <div class="product-module__head">
                              ...
                              <div class="hidden-case__close">
                                  <button type="button" data-open="Details<?/*Loc::getMessage('MP_SOLUTIONS_MORE')*/?>" data-close="Roll up<?/*Loc::getMessage('MP_SOLUTIONS_ROLL_UP')*/?>" data-submodule-toggle="case-<?=$keyItem+1?>.<?=$keyModule+1?>" class="hidden-case__close-desc">
                                      Details<?/*Loc::getMessage('MP_SOLUTIONS_MORE')*/?>
                                  </button>
                ...
                <?php endif;?>  
                  ...
                  <?endif;?>
                    ...
                    <div class="hidden-case__close">
                        <button type="button" data-close-case="case-<?=$keyItem+1?>">Roll up<?/*Loc::getMessage('MP_SOLUTIONS_ROLL_UP')*/?></button>
                    </div>
                </div>
            </div>
          </div>
