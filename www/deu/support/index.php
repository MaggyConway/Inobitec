...
$APPLICATION->SetPageProperty("title", "Inobitec / Support");
  ...
  <div class="wr">
    <form action="/eng/search/" method="GET">
      <div class="input support-search__input">
        <input type="text" name="search" id="search" placeholder="Seitensuche">
      </div>
      <button class="btn btn--light-blue-outline support-search__button" type="submit"><span>Finden</span>
...
<div class="support-form" id="support-form">
  <div class="wr">
    <div class="support-form__title">
      ...
      <h2>Fragen oder ein Problem melden</h2>
    </div>
