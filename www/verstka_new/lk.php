    ...
    <div class="page_basket_personal_info_type_tab" data-target="3">
        <div class="contact-us">
            <div class="contact-us__form">
                ...
                <label for="message" id="messageLabel">Текст сообщения</label>
                <textarea id="message"></textarea>
                <div class="verification">
                    <input type="checkbox">
                    <p id="verificationText">
                        <span>Я соглашаюсь с </span><a href="#">Лицензионным договором-офертой</a><span><br> и </span><a href="#">Обработкой персональных данных</a>
                    </p>
                </div>
            ...
            <div class="contact-us__contacts">
                ...
                <p class="contact-us__contacts-address">
                    394006, Россия, г. Воронеж,<br> ул. Бахметьева, 2Б, 5 этаж,<br> офисы 500-511
                </p>
            </div>
        </div>
    </div>
