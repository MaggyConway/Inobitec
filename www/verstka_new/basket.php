	...
	<div class="page_basket_table">
		...
		<div class="page_basket_table_p">
			...
			<div class="page_basket_table_element">
				...
				<div class="page_basket_table_element_col price">50 000 &#8381</div>
			...
			<div class="page_basket_table_element">
				...
				<div class="page_basket_table_element_col count">1 шт</div>
				<div class="page_basket_table_element_col price">30 000 &#8381</div>
				<div class="page_basket_table_element_col delete">
			...
			<div class="page_basket_table_element">
				...
				<div class="page_basket_table_element_col price">24 000 &#8381</div>
				<div class="page_basket_table_element_col delete">
					<a href="javascript:void(0);" class="page_buy_delete_basket">убрать из корзины</a>
				</div>
			</div>
		...
		<div class="page_basket_table_s">
			...
			<div class="page_basket_table_element">
				...
				<div class="page_basket_table_element_col count">1 ГОД</div>
				<div class="page_basket_table_element_col price">180 000 &#8381</div>
				<div class="page_basket_table_element_col delete">
					<a href="javascript:void(0);" class="page_buy_delete_basket disabled">убрать из корзины</a>
				</div>
			</div>
			<div class="page_basket_table_element">
				...
				<div class="page_basket_table_element_col price">162 000 &#8381</div>
				<div class="page_basket_table_element_col delete">
					<a href="javascript:void(0);" class="page_buy_delete_basket">убрать из корзины</a>
				</div>
			</div>
				...
				<div class="form_table">
					...
					<div class="form_table_col">
						<label class="input valid have_value">
							<span>ОГРН</span>
							<input type="number" placeholder="1056405010100" value="1056405010100" />
							<div class="error"></div>
						</label>
						<label class="input">
							<span>ИНН</span>
							<input type="number" placeholder="6450606508" />
							<div class="error"></div>
						</label>
						<label class="input">
							<span>КПП</span>
							<input type="number" placeholder="645001001" />
							<div class="error"></div>
						</label>
					</div>
					<div class="form_table_col">
					...
					<div class="form_table_col">
						...
						<label class="input">
							<span>Телефон</span>
							<input type="number" placeholder="+7(900)000 00 00" />
							<div class="error"></div>
						</label>
					</div>
					<div class="form_table_col">
			...
			<div class="page_basket_personal_info_type_tab" data-target="2">
				<div class="form_table">
					...
					<div class="form_table_col">
						...
						<label class="input">
							<span>ОГРНИП</span>
							<input type="number" placeholder="315645100023002" />
							<div class="error"></div>
						</label>
					</div>
					<div class="form_table_col">
