...
$APPLICATION->SetPageProperty("description", "Компания Инобитек предоставляет сотрудникам учреждений здравоохранения, частных медицинских клиник, медицинских стартапов дистрибутивы собственных тиражных продуктов для загрузки: Инобитек DICOM-Просмотрщик, Инобитек Web DICOM-Просмотрщик, Инобитек DICOM-сервер (PACS)");
$APPLICATION->SetPageProperty("keywords", "Скачать, загрузить, установить, DICOM, dicom, просмотрщик, веб просмотрщик, web просмотрщик, dicom просмотрщик для mac, dicom просмотрщик для linux, просмотровщик, viewer, сервер, server, PACS, pacs");
$APPLICATION->SetPageProperty("title", "Инобитек / Дистрибутивы собственных продуктов компании для загрузки: Инобитек DICOM-Просмотрщик, Инобитек Web DICOM-Просмотрщик, Инобитек DICOM-Сервер (PACS)");
