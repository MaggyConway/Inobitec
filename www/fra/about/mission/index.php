...
$APPLICATION->SetPageProperty("description", "Mission d'Inobitec LLC");
$APPLICATION->SetPageProperty("keywords", "Inobitec, entreprise, mission");
$APPLICATION->SetPageProperty("title", "Inobitec / Mission de l'entreprise");
