...
//print_r("TEST");
$APPLICATION->SetTitle("Se connecter");
?>
<div class="success-block">
    <div class="popup-main">
        <img src="/img/svg/checkbox.svg">
        <p class="success">Vous êtes enregistré et connecté avec succès</p>
        <button class="btn-blue" onclick="window.location.href='/fra/';">Aller à la page principale</button>
    </div>
</div>
