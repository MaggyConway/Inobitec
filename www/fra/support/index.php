...
$APPLICATION->SetPageProperty("description", "Manuel des produits Inobitec: guide de l'utilisateur, FAQ, base de connaissances et services payants sur demande");
$APPLICATION->SetPageProperty("keywords", "Manuel de DICOM Viewer, manuel de l'utilisateur du serveur PACS, FAQ, services payants Inobitec, Foire aux questions, guide de l'utilisateur de DICOM Viewer, manuel d'utilisation du serveur DICOM, téléchargez Viewer, téléchargez Inobitec DICOM Viewer, téléchargez Inobitec Web DICOM Viewer, téléchargez Inobitec DICOM Serveur, base de connaissances Inobitec");
$APPLICATION->SetPageProperty("title", "Inobitec / Soutien technique");
$APPLICATION->SetTitle("Soutien");
?>
  ...
  <div class="wr">
    <form action="/fra/search/" method="GET">
      <div class="input support-search__input">
        <input type="text" name="search" id="search" placeholder="Rechercher sur le site">
      </div>
      <button class="btn btn--light-blue-outline support-search__button" type="submit"><span>Trouver</span>
...
<div class="support-form" id="support-form">
  <div class="wr">
    <div class="support-form__title">
      ...
      <h2>Poser une question ou signaler un problème</h2>
    </div>
    <div class="support-form__toggle">
      <div class="support-form__radio">
        ...
        <label for="question">Poser une question</label>
      </div>
      <div class="support-form__radio">
        <input class="visually-hidden" type="radio" name="message-type" id="issue" value="issue">
        <label for="issue">Signaler un problème</label>
      </div>
    </div>
