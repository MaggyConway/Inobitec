...
$APPLICATION->SetPageProperty("title", "Inobitec DICOM-viewer and server for OS: Windows, Mac OS, Linux");
$APPLICATION->SetTitle("Versions à télécharger");
$no_f_links = true;
    ...
    <div class="download__documents <?=($arItem['PROPERTY_NEW_DESIGN_VALUE'])?'download__documents-viewer':''?>">
        ...
        <ul>
          <? if ( count($arItem['PROPERTY_MANUALS_VALUE']) == 1 ) {
                ...
                // echo "<pre>"; var_dump($arItem['PROPERTY_MANUALS_VALUE']); echo "</pre>";
